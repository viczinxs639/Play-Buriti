...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Botões iniciar jogos Snake, Pong e Tetris
  document.querySelector("#controlesSnake button").addEventListener("click", () => startSnake());
  document.querySelector("#controlesPong button").addEventListener("click", () => startPong());
  document.querySelector("#controlesTetris button").addEventListener("click", () => startTetris());
});
